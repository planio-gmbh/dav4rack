...
It also incorporates various fixes that were made as part of the redmine_dmsf
plugin (branch dmsf-fixes), as well as improvements done by ourselves during
development of an upcoming redmine document management plugin (branch redmine-storage).
